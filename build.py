...
RESERVED_SLUGS = {"static", "assets", "404", "feed", "sitemap", "robots", "llms", "tools", "hq", "state"}
...
def main():
    ...
    # /state/state.json — the allowlisted STATE_PUBLIC feed (pushed by the engine's
    # state-snapshot CI) must be SERVED, not just committed, or /hq/ fetches 404.
